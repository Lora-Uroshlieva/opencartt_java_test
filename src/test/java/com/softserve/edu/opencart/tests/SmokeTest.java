...
//        homePage = homePage.searchByProduct("mac");
        ...
        SearchPage searchPage = HomePage
                ...
                .searchByProduct("mac");
        Thread.sleep(1000);
        System.out.println("***"+searchPage.getExtendedSearchBlock().getProductComponentTexts());
        Assert.assertTrue(searchPage.getExtendedSearchBlock().getProductComponentTexts().contains("MacBook"));
        driver.quit();
    }
    ...
    public void smoke3TestRunner(IProduct product) throws Exception {
        ...
        Thread.sleep(1000);
        System.out.println("***" + searchPage.getExtendedSearchBlock().getProductComponentTexts());
        Assert.assertTrue(searchPage.getExtendedSearchBlock().getProductComponentTexts()
    ...
    public void smoke5Currency(IProduct product, Currencies currencyName) throws Exception {
        ...
        Assert.assertTrue(searchPage.getExtendedSearchBlock().getProductComponentTexts()
                .contains(product.getName()));
        Assert.assertEquals(searchPage.getExtendedSearchBlock().getPriceAmountByProductName(product.getName()),
